...
export default function EventSettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] text-slate-900 font-sans">
      ...
      {/* Spacing for Navbar */}
      <div className="pt-24">
        {/* Sub-Header: Integrated into flow, not fixed */}
            ...
            <aside className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-red-50/50 rounded-[2.5rem] border border-red-100 p-8">
                ...
                <p className="text-[10px] text-red-400 font-bold uppercase leading-relaxed mb-6">
                  Once a move is cancelled, all ticket holders will be notified
                  and sales will be halted immediately.
                </p>
